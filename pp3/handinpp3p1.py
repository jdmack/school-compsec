...
b_f = find_student_file('.',"b.html")
c_f = find_student_file('.',"c.html")
a_f = find_student_file('.',"a.txt")
...
if sid_f == None:
    ...
    exit(1)
if a_f == None:
    print "Unable to find a.txt file!"
    exit(1)
if b_f == None:
    print "Unable to find b.html file!"
    exit(1)
if c_f == None:
    print "Unable to find c.html file!"
    exit(1)
...
if inp == "Yes":
    ...
    shutil.copy("./"+a_f,"./"+dirname)
    shutil.copy("./"+b_f,"./"+dirname)
    shutil.copy("./"+c_f,"./"+dirname)
    if rd_f != None:
